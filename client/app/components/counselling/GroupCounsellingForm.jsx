...
import { initiateGroupBooking } from "../../../utils/api"
...
const GroupCounsellingForm = ({
  ...
  const payableAmount = calculatePayableAmount('group', noOfStudents);
  ...
  useEffect(() => {
    ...
    setGroupData((prev) => ({ ...prev, students: updated }));
    setOpenIndex(0);
  }, [noOfStudents]);
  ...
  return (
    <>
      {noOfStudents > 0 && <PayableAmountDisplay amount={payableAmount} />}
        ...
        {noOfStudents && (
          <>
            ...
            <div className="pt-6">
              ...
              >
                {loading ? "Processing..." : `Pay ₹${payableAmount} & Book Session`}
              </button>
            </div>
